      ...
      <div class="container">
        ...
        <div class="row justify-content-md-center text-light">
          <p>
            ...
            <?php } ?>
            <a href="https://github.com/AdriaanGiel/QuikLease" rel="noopener noreferrer" target="_blank" class="text-light font-weight-bold"><img class="socialicons pr-2" src="/content/logos/icon_github.svg">Quicklease</a>
          </p>
        </div>
        <!-- Video -->
