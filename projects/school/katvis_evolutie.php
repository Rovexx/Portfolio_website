      ...
      <div class="container">
        ...
        <div class="row justify-content-md-center text-light">
          <p>
            ...
            <?php } ?>
            <a href="https://github.com/Rovexx/CLE4-Games" rel="noopener noreferrer" target="_blank" class="text-light font-weight-bold"><img class="socialicons pr-2" src="/content/logos/icon_github.svg">Katvis Evolutie</a>
          </p>
        </div>
        <!-- Images -->
