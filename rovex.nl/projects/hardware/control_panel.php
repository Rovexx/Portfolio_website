        ...
        <div id="carouselIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="/rovex.nl/content/projecten/hardware/control_panel/Star_Citizen_Control_Panel_1.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/hardware/control_panel/Star_Citizen_Control_Panel_2.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/hardware/control_panel/Star_Citizen_Control_Panel_3.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/hardware/control_panel/Star_Citizen_Control_Panel_4.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/hardware/control_panel/Star_Citizen_Control_Panel_5.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/hardware/control_panel/Star_Citizen_Control_Panel_6.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/hardware/control_panel/Star_Citizen_Control_Panel_7.jpg" class="d-block w-100">
            </div>
          </div>
