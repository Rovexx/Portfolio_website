        ...
        <div id="carouselIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="/rovex.nl/content/projecten/3d_printer/ncc_1701_d_warp_core/header.png" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/3d_printer/ncc_1701_d_warp_core/NX01_Warp_core_1.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/3d_printer/ncc_1701_d_warp_core/NX01_Warp_core_2.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/3d_printer/ncc_1701_d_warp_core/NX01_Warp_core_3.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/3d_printer/ncc_1701_d_warp_core/NX01_Warp_core_4.jpg" class="d-block w-100">
            </div>
          </div>
