        ...
        <div id="carouselIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="/rovex.nl/content/projecten/misc/dansstudio_jolynda/dansstudio_jolynda_1.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/misc/dansstudio_jolynda/dansstudio_jolynda_2.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/misc/dansstudio_jolynda/header.jpg" class="d-block w-100">
            </div>
          </div>
