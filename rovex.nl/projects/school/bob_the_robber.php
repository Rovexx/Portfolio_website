    ...
    <div class="bg-blue">
      <div class="container">
        ...
        <div class="row justify-content-md-center text-light">
          ...
          <?php } ?>
            <a href="https://play.google.com/store/apps/details?id=com.ThumbsUpGames.BobTheRobber&hl=nl&gl=US" rel="noopener noreferrer" target="_blank" class="text-light font-weight-bold"><img class="socialicons pr-2" src="/rovex.nl/content/logos/icon_playstore.svg">Bob the Robber</a>
          </p>
        </div>
        <!-- Video -->
        ...
        <div id="carouselIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="/rovex.nl/content/projecten/school/bob_the_robber/bob_the_robber_1.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/school/bob_the_robber/bob_the_robber_2.png" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/school/bob_the_robber/bob_the_robber_3.png" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/school/bob_the_robber/bob_the_robber_4.png" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/school/bob_the_robber/bob_the_robber_5.jpg" class="d-block w-100">
            </div>
          </div>
