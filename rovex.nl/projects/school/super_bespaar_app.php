      ...
      <div class="container">
        ...
        <div class="row justify-content-md-center text-light">
          <p>
            ...
            <?php } ?>
            <a href="https://github.com/Rovexx/superbespaarapp" rel="noopener noreferrer" target="_blank" class="text-light font-weight-bold"><img class="socialicons pr-2" src="/rovex.nl/content/logos/icon_github.svg">Superbespaarapp</a>
          </p>
        </div>
        <!-- Images -->
        <div id="carouselIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="/rovex.nl/content/projecten/school/super_bespaar_app/header.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/school/super_bespaar_app/super_bespaar_app.jpg" class="d-block w-100">
            </div>
          </div>
