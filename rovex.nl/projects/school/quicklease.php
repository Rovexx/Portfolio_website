      ...
      <div class="container">
        ...
        <div class="row justify-content-md-center text-light">
          <p>
            ...
            <?php } ?>
            <a href="https://github.com/AdriaanGiel/QuikLease" rel="noopener noreferrer" target="_blank" class="text-light font-weight-bold"><img class="socialicons pr-2" src="/rovex.nl/content/logos/icon_github.svg">Quicklease</a>
          </p>
        </div>
        <!-- Video -->
        ...
        <div id="carouselIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="/rovex.nl/content/projecten/school/leaseplan_quicklease_fleet/header.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/school/leaseplan_quicklease_fleet/quicklease_1.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/school/leaseplan_quicklease_fleet/quicklease_2.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/school/leaseplan_quicklease_fleet/quicklease_3.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/school/leaseplan_quicklease_fleet/quicklease_4.jpg" class="d-block w-100">
            </div>
          </div>
