      ...
      <div class="container">
        ...
        <div class="row justify-content-md-center text-light">
          <p>
            ...
            <?php } ?>
            <a href="https://github.com/Rovexx/CLE4-Games" rel="noopener noreferrer" target="_blank" class="text-light font-weight-bold"><img class="socialicons pr-2" src="/rovex.nl/content/logos/icon_github.svg">Katvis Evolutie</a>
          </p>
        </div>
        <!-- Images -->
        <div id="carouselIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="/rovex.nl/content/projecten/school/katvis_evolutie/katvis_evolutie_1.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/school/katvis_evolutie/katvis_evolutie_2.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/school/katvis_evolutie/katvis_evolutie_3.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/school/katvis_evolutie/katvis_evolutie_4.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/school/katvis_evolutie/katvis_evolutie_5.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/school/katvis_evolutie/katvis_evolutie_6.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/school/katvis_evolutie/katvis_evolutie_7.jpg" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/school/katvis_evolutie/katvis_evolutie_8.jpg" class="d-block w-100">
            </div>
          </div>
