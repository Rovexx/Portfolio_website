    ...
    <div class="bg-blue">
      <div class="container">
        ...
        <div class="row justify-content-md-center text-light">
          ...
          <?php } ?>
            <a href="https://github.com/Rovexx/Deltec_robot" rel="noopener noreferrer" target="_blank" class="text-light font-weight-bold"><img class="socialicons pr-2" src="/rovex.nl/content/logos/icon_github.svg">Deltec</a>
          </p>
        </div>
        <div class="row">
          <!-- Eyes images -->
            ...
            <div id="carouselIndicators_1" class="carousel slide carousel-fade" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="/rovex.nl/content/projecten/school/deltec/Deltec_ogen_1_transparant.png" class="d-block w-100">
                </div>
                <div class="carousel-item">
                  <img src="/rovex.nl/content/projecten/school/deltec/Deltec_ogen_2_transparant.png" class="d-block w-100">
                </div>
                <div class="carousel-item">
                  <img src="/rovex.nl/content/projecten/school/deltec/Deltec_ogen_3_transparant.png" class="d-block w-100">
                </div>
                <div class="carousel-item">
                  <img src="/rovex.nl/content/projecten/school/deltec/Deltec_wielen_1_transparant.png" class="d-block w-100">
                </div>
                <div class="carousel-item">
                  <img src="/rovex.nl/content/projecten/school/deltec/Deltec_wielen_2_transparant.png" class="d-block w-100">
                </div>
                <div class="carousel-item">
                  <img src="/rovex.nl/content/projecten/school/deltec/Deltec_wielen_3_transparant.png" class="d-block w-100">
                </div>
              </div>
          ...
          <div class="col">
            ...
            <div id="carouselIndicators_2" class="carousel slide carousel-fade" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="/rovex.nl/content/projecten/school/deltec/modules/Deltec_ogen_1_transparant.png" class="d-block w-100">
                </div>
                <div class="carousel-item">
                  <img src="/rovex.nl/content/projecten/school/deltec/modules/Deltec_ogen_2_transparant.png" class="d-block w-100">
                </div>
                <div class="carousel-item">
                  <img src="/rovex.nl/content/projecten/school/deltec/modules/Deltec_ogen_3_transparant.png" class="d-block w-100">
                </div>
                <div class="carousel-item">
                  <img src="/rovex.nl/content/projecten/school/deltec/modules/Deltec_wielen_1_transparant.png" class="d-block w-100">
                </div>
                <div class="carousel-item">
                  <img src="/rovex.nl/content/projecten/school/deltec/modules/Deltec_wielen_2_transparant.png" class="d-block w-100">
                </div>
                <div class="carousel-item">
                  <img src="/rovex.nl/content/projecten/school/deltec/modules/Deltec_wielen_3_transparant.png" class="d-block w-100">
                </div>
              </div>
        ...
        <div id="carouselIndicators_3" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="/rovex.nl/content/projecten/school/deltec/header.png" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/school/deltec/Deltec_v2_hardware.png" class="d-block w-100">
            </div>
            <div class="carousel-item">
              <img src="/rovex.nl/content/projecten/school/deltec/Deltec_hardware_transparant.png" class="d-block w-100">
            </div>
          </div>
